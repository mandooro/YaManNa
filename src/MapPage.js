...
class MapPage extends React.Component {
  ...
  componentDidMount() {
    ...
    if (navigator.geolocation) {
      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          if (params.id !== undefined) {
            ...
            const starCountRef = getFireDB().ref(params.id);
            ...
            starCountRef.on('child_added', (data) => {
              ...
              // 마커 이미지의 이미지 크기 입니다
              const imageSize = new window.daum.maps.Size(24, 35);
              ...
              // 마커 이미지의 이미지 크기 입니다
              const imageSize2 = new window.daum.maps.Size(40, 50);

              // 마커 이미지를 생성합니다
              const markerImage2 = new window.daum.maps.MarkerImage(imageSrc, imageSize2);

              const center = new window.daum.maps.LatLng(garo / count, sero / count);
              // 마커를 생성합니다
              marker = new window.daum.maps.Marker({
                map, // 마커를 표시할 지도
                position: center, // 마커를 표시할 위치
              ...
              const iwContent = '당신들의 중간은 여기입니다'; // 인포윈도우에 표시할 내용
              const iwRemoveable = true;
      ...
      const locPosition = new window.daum.maps.LatLng(33.450701, 126.570667);
